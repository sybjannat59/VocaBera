import { desc, ne, sql, and, eq } from "drizzle-orm";
import { db } from "@/db";
import { quizSessions, reviewLogs } from "@/db/schema";
import { ensureSchema, jsonError, serializeSession } from "@/lib/server/words";
...
export async function GET(req: Request) {
  try {
    ...
    return jsonError("Could not load progress", 500);
  }
}
